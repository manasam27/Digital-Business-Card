...
export default function Profile(){
    return (
        ...
        <div className="profile">
            <img src="./images/manasamm.jpeg" width = '250px' alt="profile"/>
            <header className="profile-info">
                <h1 className="profile-name">Manasa M</h1>
                <h2 className="profile-occ">Recent graduate in B.E.</h2>
                <h3 className="profile-web">manasa_m.website</h3>
            </header>
            <div className="btns-contact">
                <a href="#" className="cta-btn cta-btn-email">
                ...
                <a href="https://www.linkedin.com/in/manasa-m27/" className="cta-btn cta-btn-linkedin">
                    <span className="cta-btn-icon">
